...
pdf_scarlatti_A4_175x2 = k1 k35 k59 k62 k63 k67 k87 k100 k102 k185 k322 k333 k341 k343
...
#
scarlatti_dirs = k1 k27 k30 k35 k37 k41 k48 k53 k54 k55 k56 k58 k59 k61 k62 k63 k64 k67 k77 k82 k87 k93 k95 k99 k100 k102 k185 k293 k308 k314 k322 k333 k341 k343 k373 k417 k491
...
book2-a4-175x297.pdf: book2-full-a4-175x297.pdf
	gs -dBATCH -dNOPAUSE -q -sDEVICE=pdfwrite -sOutputFile=$@ \
	 ...
	 -dFirstPage=39  -dLastPage=70  -f $< \
	 -dFirstPage=73  -dLastPage=88  -f $< \
	 -dFirstPage=93  -dLastPage=94  -f $< \
